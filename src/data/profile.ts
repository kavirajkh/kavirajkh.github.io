export const profile = {
  ...
  photo: {
    ...
    webp: '/images/kaviraj-profile.webp',
  ...
  yearsAtApple: '10+',
  studentsServed: '4M+',
  email: 'kaviraj.kh@gmail.com',
  linkedin: 'https://www.linkedin.com/in/kavirajkh',
  currentFocus: [
    'Staff-level technical leadership & mentorship',
    'Distributed systems & system design',
    'High-scale backend performance optimization',
